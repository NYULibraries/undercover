...
<body id="<?php print $body_id; ?>" class="<?php print $body_classes; ?>">
  <div id="page" class="page">
    <div id="page-inner" class="page-inner">
      ...
      <div id="undercover-user">
      	<div id="undercover-user-inner" class="clearfix">
      	<?php if ($search_box): ?>
          <div id="undercover-search-box"><?php print $search_box; ?></div>
        <?php endif; ?>
        <ul>
          <li class="undercover-user-name"><?php print $user->name; ?></li>
          <li><a href="user/<?php print $user->uid;?>"><?php print t('My Account'); // why this is not a block? ?></a></li>
          <li><?php print $log_in_out_link; ?></li>
        </ul>
      </div>
    </div>
          ...
          <?php if ($logo || $site_name || $site_slogan): ?>
            <div id="header-site-info" class="header-site-info block">
              <div id="header-site-info-inner" class="header-site-info-inner inner">
                <?php if ($logo): ?><div id="logo"><a href="<?php print check_url($front_page); ?>" title="<?php print t('Home'); ?>"><img src="<?php print $logo; ?>" alt="<?php print t('Home'); ?>" /></a></div><?php endif; ?>
                <?php if ($site_name || $site_slogan): ?>
                <div id="site-name-wrapper" class="clearfix">
                  <?php if ($site_name): ?><span id="site-name"><a href="<?php print check_url($front_page); ?>" title="<?php print t('Home'); ?>"><?php print $site_name; ?></a></span><?php endif; ?>
                  <?php if ($site_slogan): ?><span id="slogan"><?php print $site_slogan; ?></span><?php endif; ?>
                </div>
                <?php endif; ?>
              </div>
            </div>
