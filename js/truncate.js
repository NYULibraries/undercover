...
(function($) {
  ...
  $.fn.truncate = function(options) {
    ...
    $(this).each( function( index ) {
      ...
      findNodeForMore(truncated_node).append('... [ <a href="#show-more-content-' + index + '" id="smc-' + index + '">' + opts.more + '</a> ]');
      findNodeForLess(full_node).append(' [ <a href="#smc-' + index + '" id="slc-' + index + '">' + opts.less + '</a> ]');
